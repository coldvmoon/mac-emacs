...
values."
  (setq-default
   ...
   '(
     ...
     pdf-tools
     common
     ;;(elfeed :variables rmh-elfeed-org-files (list "/Volumes/work/emacs/rss/news.org"))
     )
